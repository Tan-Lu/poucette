 ...
 * [pouc.yml](pouc.yml)
     * Determines how your purl.obolibrary.org/obo/pouc/ redirects will be handled
     ...
     * Paste in the contents of [pouc.yml](pouc.yml)
 ...
 * [pouc.md](pouc.md)
     ...
     * Paste in the contents of [pouc.md](pouc.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
